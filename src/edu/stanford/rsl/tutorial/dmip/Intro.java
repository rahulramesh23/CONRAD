...
public class Intro {
	...
	public static void gridIntro(){
		...
		for (int x = 0; x < imageSizeX; x++) {
			for (int y = 0; y < imageSizeY; y++) {
				...
				//if (Math.sqrt((x-128)*(x-128) + (y-128)*(y-128)) < 50) {
		...
		String filename = "/proj/i5dmip/rahulramesh23/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12.dcm";
		...
		String outFilename ="/proj/i5dmip/rahulramesh23/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12out.tif";
		//TODO
	...
	public static void basicIntro()
	{
		...
		//Min element of a vector
		double min = vRand.min();
		System.out.println("min=" + min);
		//Euclidean norm of a vector
		double normL2 = vRand.norm(VectorNormType.VEC_NORM_L2);
		System.out.println("eucleidien=" + normL2);
		...
		//transpose M
		System.out.println("Transpose of matrix m: " + M.transposed());
		//copy matrix
		...
		SimpleMatrix ResMat = SimpleOperators.multiplyMatrixProd(Mcopy, M);
