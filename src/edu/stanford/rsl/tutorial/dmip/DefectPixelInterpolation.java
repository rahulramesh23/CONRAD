...
public class DefectPixelInterpolation {
	...
	public Grid2D interpolateSpectral(Grid2D image, Grid2D mask, int maxIter, boolean zeroPadding)
	{
		...
		for(int i = 0; i < maxIter; i++)
		{
				...
				(s1 == halfDim[0] && t1 == halfDim[1]))
			{
				...
				Complex GVal = new Complex(G.getRealAtIndex(s1, t1),G.getImagAtIndex(s1,t1));//TODO 
			...
			else
			{
				...
				Complex FHatNextVal_s2t2 = new Complex(FHatNext.getRealAtIndex(s2, t2),FHatNext.getImagAtIndex(s2,t2));//TODO 
				Complex GVal = new Complex(G.getRealAtIndex(s1, t1),G.getImagAtIndex(s1,t1));//TODO 
				...
				Complex val = ((GVal.mul(WVal_00)).sub(GVal.getConjugate().mul(WVal_twice))).mul(dim[0]*dim[1]);//TODO 
	...
	public static void main(String[] args) {
		...
		String filename = "/proj/i5dmip/rahulramesh23/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/testimg.bmp";
		String filenameMask = "/proj/i5dmip/rahulramesh23/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mask.bmp";
		...
		defectImage.getGridOperator().multiplyBy(defectImage,  mask);//TODO
